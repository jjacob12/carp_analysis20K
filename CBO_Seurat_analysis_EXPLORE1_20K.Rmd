...
#----------------------------------------------------------------------------------------------
#----------------------------------------------------------------------------------------------
# 15 July 2022 - this clustering result generates same cell types as 'seurat.phase'
...
```{r cluster0_size_cbo.cluster.markers}
# cluster 0 size = 224 cells
cluster0.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 0, ]
nrow(cluster0.genes)
```
...
```{r cluster1_size_cbo.cluster.markers}
# cluster 1 size = 561 cells
cluster1.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 1, ]
nrow(cluster1.genes)
```
...
```{r cluster2_size_cbo.cluster.markers}
# cluster 2 size = 233 cells
cluster2.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 2, ]
nrow(cluster2.genes)
```
...
```{r cluster3_size_cbo.cluster.markers}
# cluster 3 size = 409 cells
cluster3.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 3, ]
nrow(cluster3.genes)
```
...
```{r cluster4_size_cbo.cluster.markers}
# cluster 4 size = 279 cells
cluster4.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 4, ]
nrow(cluster4.genes)
```
...
```{r cluster5_size_cbo.cluster.markers}
# cluster 5 size = 65 cells
cluster5.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 5, ]
nrow(cluster5.genes)
```
...
```{r cluster6_size_cbo.cluster.markers}
# cluster 6 size = 838 cells
cluster6.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 6, ]
nrow(cluster6.genes)
```
...
```{r cluster7_size_cbo.cluster.markers}
# cluster 7 size = 559 cells
cluster7.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 7, ]
nrow(cluster7.genes)
```
...
```{r cluster8_size_cbo.cluster.markers}
# cluster 8 size = 725 cells
cluster8.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 8, ]
nrow(cluster8.genes)
```
...
```{r cluster9_size_cbo.cluster.markers}
# cluster 9 size = 491 cells
cluster9.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 9, ]
nrow(cluster9.genes)
```
...
```{r cluster10_size_cbo.cluster.markers}
# cluster 10 size = 945 cells
cluster10.genes <- cbo.cluster.markers[cbo.cluster.markers$cluster == 10, ]
nrow(cluster10.genes)
```
